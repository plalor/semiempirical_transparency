...
source_dir="/home/plalor/alphaCurveSim/src"
...
do
  ...
  sed -e "s|output_dir|$output_dir|" -e "s|input_file|$input_file|" -e "s|output_file|$output_file|" $run_dir/batch_default.sh > $output_dir/$filebase.sh
